...
window.LelleeRecoveryJourneySwitcher={ensure:ensureSwitcher,open:openMyJourneys,version:'2026-09-13-v10'};
...
if(!document.querySelector('script[data-lellee-account-menu]')){
  const s=document.createElement('script');
  s.src='/account-menu-visibility-runtime.js?v=20260913-3';
  s.async=false;
