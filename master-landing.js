(() => {
  ...
  const copy={
    en:{
      ...
      hero_kicker:'WELCOME TO LELLEE',hero_title:'<span>Your journey.</span><span>Your support.</span><em>Your way.</em>',hero_body:'Guided daily support and practical tools to help you move through the part of life you’re navigating now.',hero_note:'It only takes a few answers to find a good place to begin.',journey_title:'YOUR LELLEE JOURNEY',journey_subtitle:'One account • Support that can grow with you',support_heading:'How can we support you today?',support_subheading:'These topics can move based on approved demand and search trends, while every Lellee support path stays available.',help_choose:"I’m not sure — help me figure it out →",
    ...
    es:{
      ...
      hero_kicker:'BIENVENIDO A LELLEE',hero_title:'<span>Tu camino.</span><span>Tu apoyo.</span><em>A tu manera.</em>',hero_body:'Apoyo diario guiado y herramientas prácticas para ayudarte con la etapa de vida que estás atravesando ahora.',hero_note:'Solo se necesitan unas pocas respuestas para encontrar un buen punto de partida.',journey_title:'TU CAMINO CON LELLEE',journey_subtitle:'Una cuenta • Apoyo que puede crecer contigo',support_heading:'¿Cómo podemos apoyarte hoy?',support_subheading:'Los temas pueden cambiar según la demanda aprobada y las tendencias de búsqueda, pero todas las áreas de apoyo permanecen disponibles.',help_choose:'No estoy seguro — ayúdame a decidir →',
